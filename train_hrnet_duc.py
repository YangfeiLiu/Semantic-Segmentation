...
from ReadData import MyData, HRData
import torch
...
class Trainer():
    def __init__(self, args):
        ...
        train_set = HRData(root=args.root, phase='train', img_mode=args.img_mode, n_classes=args.num_classes, size=args.size, scale=args.scales)
        self.train_loader = DataLoader(train_set, batch_size=args.batch_size, shuffle=True,
                                       num_workers=args.num_workers, pin_memory=True, drop_last=False)
        valid_set = HRData(root=args.root, phase='valid', img_mode=args.img_mode, n_classes=args.num_classes, size=args.size, scale=args.scales)
