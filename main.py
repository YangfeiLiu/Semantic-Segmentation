...
def main():
    ...
    parser.add_argument('--batch_size', default=56)
    ...
    parser.add_argument('--arch', default='resnet101', choices=['resnet101', 'resnet50', 'seresnet50', 'xception'], help='deeplab backbone')
    ...
    parser.add_argument('--root', default='/workspace/lyf/train/', help='train data path')
    parser.add_argument('--model_path', default='/workspace/lyf/train/save_model/', help='path to save checkpoint')
