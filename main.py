...
def main():
    ...
    parser.add_argument('--root', default='/media/hb/d2221920-26b8-46d4-b6e5-b0eed6c25e6e/train/', help='train data path')
    parser.add_argument('--model_path', default='/media/hb/d2221920-26b8-46d4-b6e5-b0eed6c25e6e/save_model/', help='path to save checkpoint')
